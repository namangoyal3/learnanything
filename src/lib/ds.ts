...
export const ds = {
  ...
  btnPrimary:
    "rounded-[var(--ds-radius-md)] bg-[var(--green-primary)] border-b-4 border-[var(--green-dark)] font-black text-black active:border-b-2 active:translate-y-[2px] transition-all",
