    ...
    const res = await safeFetch(
      "https://45bwzj1sgc-dsn.algolia.net/1/indexes/WaaSJobListing/query",
      {
        ...
        headers: {
          ...
          "x-algolia-api-key": "Zjk2ZDk1OTQ4OGEyMGFkY2M0YWU4NzZlMWZlOWUwMGI5YTRmZWJjZGZmNWYwYzc4MGVjNWZlMDQ4YzMxMTBmaWx0ZXJzPWlzX3JlbW90ZSUzQXRydWUmdmFsaWRVbnRpbD0xNzc0NDI1NjAw",
        },
        body: JSON.stringify({
