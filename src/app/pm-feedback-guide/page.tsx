            ...
            {SBI_MODEL.map((s, i) => (
              <div key={i} className="bg-[#111] border border-white/10 rounded-xl p-5">
                <div className="flex items-center gap-3 mb-2">
                  <div className="w-10 h-10 rounded-full bg-[#7c3aed]/20 border border-[#7c3aed]/40 text-purple-300 flex items-center justify-center font-bold">{s.letter}</div>
        ...
        <section className="bg-[#0f0f0f] py-16">
          <div className="max-w-3xl mx-auto px-4">
            ...
            <div className="space-y-5">
              {SCRIPTS.map((s, i) => (
                <div key={i} className="bg-[#111] border border-white/10 rounded-xl p-5">
                  <p className="text-xs text-purple-400 uppercase tracking-wider mb-3">{s.situation}</p>
