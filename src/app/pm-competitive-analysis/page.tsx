            ...
            {WHAT_TO_TRACK.map((w, i) => (
              <div key={i} className="bg-[#111] border border-white/10 rounded-xl p-5">
                <div className="flex flex-wrap items-start justify-between gap-2 mb-2">
                  ...
                  <span className="text-xs bg-[#1a1a2e] border border-white/10 rounded-full px-2 py-1 text-white/60">{w.frequency}</span>
                </div>
                <p className="text-sm text-white/60 mb-2">{w.what}</p>
                <p className="text-xs text-purple-400">🔧 How: <span className="text-white/70">{w.how}</span></p>
              </div>
            ))}
          </div>
        </section>
          ...
          <div className="max-w-3xl mx-auto px-4">
            ...
            <div className="space-y-5">
              {WHEN_TO_DO_WHAT.map((w, i) => (
                <div key={i} className="bg-[#111] border border-white/10 rounded-xl p-5">
                  <p className="text-xs text-purple-400 uppercase tracking-wider mb-2">When they: {w.they_do}</p>
