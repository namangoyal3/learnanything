      ...
      <nav className="sticky top-0 z-50 border-b border-[var(--border-color)] bg-[var(--bg-primary)]/90 backdrop-blur-md">
        <div className="max-w-5xl mx-auto px-5 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <BrowserLink
              href="/login"
              className="px-4 py-2 rounded-xl border border-[var(--border-color)] text-[var(--text-secondary)] hover:text-white hover:border-[var(--green-primary)]/40 text-sm font-bold transition-colors"
            >
              Log in
            </BrowserLink>
            <BrowserLink
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:gap-16">
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <BrowserLink
                href="/login"
                className="inline-flex items-center px-5 py-4 rounded-2xl border border-[var(--border-color)] text-[var(--text-secondary)] text-sm font-bold hover:text-white hover:border-[var(--green-primary)]/40 transition-colors"
              >
