            ...
            {AARRR.map((a, i) => (
              <div key={i} className="bg-[#111] border border-white/10 rounded-2xl p-5">
                <div className="flex items-center gap-3 mb-2">
                  <span className="w-8 h-8 rounded-full bg-[#7c3aed]/20 text-purple-400 font-bold text-sm flex items-center justify-center">{i + 1}</span>
                ...
                <div className="ml-11 grid grid-cols-1 md:grid-cols-2 gap-3">
                  <div className="bg-[#7c3aed]/5 border border-[#7c3aed]/20 rounded-lg p-3">
                    <p className="text-xs text-purple-400 mb-1">🔧 Growth PM work</p>
