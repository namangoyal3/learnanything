          ...
          <div className="space-y-3">
            {CATEGORIES.map((c, i) => (
              <div key={i} className="bg-[#111] border border-white/10 rounded-xl p-4">
                ...
                <p className="text-xs text-purple-400">Engagement: <span className="text-white/70">{c.engagement}</span></p>
              </div>
            ))}
          </div>
        </section>
            ...
            <div className="space-y-3">
              {INFLUENCE_INTEREST.map((i, idx) => (
                <div key={idx} className="bg-[#111] border border-white/10 rounded-xl p-4">
                  <p className="font-semibold text-purple-400 text-sm mb-1">{i.group}</p>
