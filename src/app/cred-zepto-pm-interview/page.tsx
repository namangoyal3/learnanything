            ...
            <div className="bg-[#111] border border-white/10 rounded-2xl p-6 mb-6">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-purple-400">{company.tagline}</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                <div className="bg-[#7c3aed]/5 border border-[#7c3aed]/20 rounded-lg p-3">
                  <p className="text-xs text-purple-400 mb-1">🎯 Unique PM bar</p>
                ...
                <div key={i} className="bg-[#111] border border-white/10 rounded-xl p-5">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="bg-[#7c3aed]/5 border border-[#7c3aed]/20 rounded-xl p-3">
                      <p className="text-xs text-purple-400 mb-1">💡 Tip</p>
