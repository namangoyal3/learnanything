        ...
        {checking ? (
          ...
          <form onSubmit={onSubmit} className="space-y-3">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full rounded-xl bg-[var(--green-primary)] px-3 py-3 text-sm font-black text-black transition-colors hover:bg-[var(--green-dark)] disabled:opacity-60"
            >
