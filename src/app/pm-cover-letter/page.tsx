            ...
            {STRUCTURE.map((s, i) => (
              <div key={i} className="bg-[#111] border border-white/10 rounded-2xl p-6">
                <div className="flex flex-wrap items-start justify-between gap-2 mb-2">
                  ...
                  <span className="text-xs bg-[#1a1a2e] border border-white/10 rounded-full px-2 py-1 text-white/60">{s.words}</span>
                </div>
                <p className="text-sm text-purple-400 mb-3">🎯 Goal: {s.goal}</p>
        ...
        <section className="bg-[#0f0f0f] py-16">
          <div className="max-w-3xl mx-auto px-4">
            ...
            <div className="space-y-6">
              {EXAMPLES.map((ex, i) => (
                <div key={i} className="bg-[#111] border border-white/10 rounded-2xl p-6">
                  <p className="text-xs text-purple-400 uppercase tracking-wider mb-4">{ex.title}</p>
