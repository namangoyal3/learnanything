            ...
            {ROUNDS.map((round, i) => (
              <div key={round.name} className="bg-[#111] border border-white/10 rounded-2xl p-6">
                <div className="flex flex-wrap items-start justify-between gap-3 mb-3">
                  ...
                  <span className="text-xs bg-[#1a1a2e] border border-white/10 rounded-full px-3 py-1 text-white/50">{round.weight}</span>
                </div>
              ...
              {PREP_PLAN.map((week, i) => (
                <div key={i} className="bg-[#111] border border-white/10 rounded-xl p-5">
                  <div className="flex items-center gap-3 mb-3">
                    <span className="text-xs bg-[#7c3aed]/20 text-purple-400 px-2 py-0.5 rounded-full">{week.week}</span>
