            ...
            {LEADERSHIP_LEVELS.map((l, i) => (
              <div key={i} className="bg-[#111] border border-white/10 rounded-2xl p-6">
                <div className="flex flex-wrap items-start justify-between gap-2 mb-2">
                  ...
                  <span className="text-xs bg-[#7c3aed]/20 text-purple-400 px-2 py-1 rounded-full">{l.stage}</span>
                </div>
            ...
            <div className="space-y-4">
              {LEADERSHIP_SKILLS.map((s, i) => (
                <div key={i} className="bg-[#111] border border-white/10 rounded-xl p-5">
                  ...
                  <p className="text-xs text-purple-400">💪 How to grow it: <span className="text-white/70">{s.grow}</span></p>
                </div>
              ))}
            </div>
          </div>
