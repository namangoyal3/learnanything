          ...
          <div className="bg-[var(--bg-card)] border-2 border-[var(--green-primary)]/30 rounded-2xl p-8 mb-10">
            ...
            <div className="text-center">
              <a
                ...
                className="inline-flex items-center justify-center gap-3 px-8 py-4 rounded-2xl bg-[var(--green-primary)] hover:bg-[var(--green-dark)] border-b-4 border-[var(--green-dark)] active:border-b-2 active:translate-y-[2px] text-black text-sm font-black uppercase tracking-wide transition-all"
              >
