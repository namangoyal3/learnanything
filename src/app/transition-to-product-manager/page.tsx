...
export const metadata: Metadata = {
  title: "How to Transition to Product Management (2026) — Engineer, Designer, MBA | PM Streak",
  description:
          ...
          <div className="space-y-8">
            {PATHS.map((path) => (
              <div key={path.from} className="bg-[#111] border border-white/10 rounded-2xl p-6">
                ...
                <div className="bg-[#7c3aed]/5 border border-[#7c3aed]/20 rounded-xl p-4 mb-4">
                  <p className="text-xs text-purple-400 font-medium mb-1">💬 The narrative that works</p>
