          ...
          <div className="space-y-5">
            {PHASES.map((p, i) => (
              <div key={i} className="bg-[#111] border border-white/10 rounded-2xl p-6">
                ...
                <p className="text-sm text-purple-400 mb-4">🎯 Theme: {p.theme}</p>
                <div className="mb-3">
                ...
                <div className="bg-[#7c3aed]/5 border border-[#7c3aed]/20 rounded-lg p-3">
                  <p className="text-xs text-purple-400">📅 Milestone meeting: <span className="text-white/70">{p.meeting}</span></p>
                </div>
              </div>
            ))}
          </div>
