#!/bin/bash
# Publish 2 new SEO articles written on 2026-07-30 by the automated content pipeline.
...
publish "ai-workflow-stack-product-managers-2026.json" \
  "The AI Workflow Stack Every Product Manager Needs in 2026 (~1054 words)"

publish "competitive-analysis-pm-2hour-framework.json" \
  "Competitive Analysis for PMs: The 2-Hour Framework (~1066 words)"
